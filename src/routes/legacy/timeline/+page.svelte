<script>
    ...
    import VerticalTimelineItem from "../../../components/legacy/VerticalTimelineItem.svelte";
    import Carousel from "../../../components/legacy/Carousel.svelte";
...
<main>
    ...
    >
        ...
        <Carousel
            ...
            pages={[
                {
                    title: "<span class='mdi mdi-play'></span> Montázs videó by Brotond Productions",
                    background: `url('${imgKoloraBirthdayCake}')`,
                    onclick: () =>
                        window.open(

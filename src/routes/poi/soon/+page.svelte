...
<main>
    ...
    <p>
        Már meg is találtál egyet! Nézz vissza ide Április 11-én!
    </p>
    <button
        class="btn"
        onclick={() => {
            ...
            const description = encodeURIComponent("Néhány városban matricák bukkantak fel. Ha ezeket megtalálod, verseket és egyéb meglepetéseket találhatsz.");
            window.open(

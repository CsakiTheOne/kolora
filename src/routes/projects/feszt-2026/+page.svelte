<script lang="ts">
    ...
    import imgMikuWave from "$lib/images/miku-wave.png";
...
<header class="relative">
    ...
    />
    <img
        class="absolute w-8 aspect-square bottom-0 right-4 sm:right-16 lg:right-32 -translate-x-3.5 translate-y-[-70%]"
        src={imgMikuWave}
        alt="Miku Wave"
        title="Miku integet"
    />
    ...
    <div class="flex flex-row items-center gap-4">
        ...
        >
            <p class="line-clamp-1 text-ellipsis">
                <span>24.</span>
                <span class="hidden lg:inline" class:inline={selectedDay === 24}
                    >Csütörtök</span
                >
            </p>
        </button>
        ...
        >
            <p class="line-clamp-1 text-ellipsis">
                <span>25.</span>
                <span class="hidden lg:inline" class:inline={selectedDay === 25}
                    >Péntek</span
                >
            </p>
        </button>
        ...
        >
            <p class="line-clamp-1 text-ellipsis">
                <span>26.</span>
                <span class="hidden lg:inline" class:inline={selectedDay === 26}
                    >Szombat</span
                >
            </p>
        </button>
...
<footer
    class="flex flex-row items-center justify-between p-4 gap-4 text-white text-center"
>
    <p class="">
        <a

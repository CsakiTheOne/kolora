...
<main class="container-column">
    <ComicPanel innerClass="container-column panel-blue">
        ...
        {:else if !isMember}
            ...
            <p>
                Ha Kolora tag vagy, de mégis ezt látod, ellenőrizd, hogy be
        ...
        {:else}
            <div class="tools-grid">
                ...
                >
                    ...
                    <p class="text-small">
                        Fontos linkek és forrásaink ide költöztek.
                    </p>
                    <p>
                        <a
                ...
                >
                    ...
                    <p>
                        Ha valakinek segítenél Kolora fiókot létrehozni, másold
                        ki ezt a linket és küldd el neki.
                    </p>
            ...
            <ComicPanel innerClass="container-column panel-red-variant">
                ...
                <label class="field-label" for="qr-fallback-url">
                    Mi történjen, ha valaki beolvassa a QR kódot az egyik
                    matricánkon?
                </label>
                <input
                    id="qr-fallback-url"
                ...
                />
                <p class="text-small">
                    Írj be egy sima / jelet a főoldalhoz vagy másolj be
                    bármilyen linket, pl.: https://instagram.com/koloraegyesulet
                </p>
            </ComicPanel>
            ...
            <ComicPanel innerClass="container-column panel-base">
                ...
                <a href="/member-tools/2026-04-11">
                    <button class="btn">
                        Költészet napi kincsvadászat 2026 statisztikák
                    </button>
                </a>
            </ComicPanel>
        {/if}
